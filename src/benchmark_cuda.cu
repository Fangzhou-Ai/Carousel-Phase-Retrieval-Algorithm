...
void ShrinkWrap_CPRA_CUDA_Sample(int epi, int iter)
{
    // 2D part test
    // Shrinkwrap
    CPRA::Cpra<float, CPRA::IMPL_TYPE::CUDA> obj1(M, N, L, BATCHSIZE_CPRA);
    //CPRA::Cpra<float, CPRA::IMPL_TYPE::CUDA> obj2(M, N, L, BATCHSIZE_CPRA);
...
{
    CPRA::Cpra<float, CPRA::IMPL_TYPE::CUDA> obj1(M, N, L, BATCHSIZE_CONV);
